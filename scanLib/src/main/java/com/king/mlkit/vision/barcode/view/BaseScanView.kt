...
import com.king.mlkit.vision.camera.CameraScan.OnScanResultCallback
import java.io.File
...
abstract class BaseScanView @JvmOverloads constructor(
     ...
     * 结果回调，提供给外部使用
     */
    var onResult: ((AnalyzeResult<List<Barcode>>) -> Unit)? = null
     ...
     * 保证避免多次调用start()
     */
    protected var isShoudCreateOpen = true
